...
```
![](capturas/oracle-A1-13.png)

Pruebas de funcionamiento.
```sql
	connect USRPRACTICA1;
```
![](capturas/oracle-A1-13-1.png)

```sql
		ALTER USER USRPRACTICA1 ACCOUNT UNLOCK;
```
![](capturas/oracle-A1-13-2.png)
